      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        <div className="col-span-7 place-self-center text-center sm:text-right justify-self-start">
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg lg:text-xl mb-6">
            "Tech-savvy beginner passionate about coding, innovation, and
            technology."
          </p>
          ...
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-800 text-white"
            >
              Hire Me
            </Link>

            <Link
              href="./Mahak_Garg_Resume.pdf"
